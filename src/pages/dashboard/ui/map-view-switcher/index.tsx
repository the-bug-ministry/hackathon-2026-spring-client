    ...
    <div className="absolute top-10 left-6 z-30">
      ...
      >
        ...
        >
          <TabsTrigger
            value="2d"
            className="group h-12 w-full justify-start gap-3 rounded-xl border border-transparent px-3 text-left text-base font-semibold text-slate-300 transition-all duration-200 hover:bg-white/5 hover:text-white data-[state=active]:border-white/10 data-[state=active]:bg-white/10 data-[state=active]:text-white data-[state=active]:shadow-none"
          >
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-white/5 transition-colors duration-200 group-hover:bg-white/10 group-data-[state=active]:bg-white/10">
          ...
          <TabsTrigger
            value="3d"
            className="group h-12 w-full justify-start gap-3 rounded-xl border border-transparent px-3 text-left text-base font-semibold text-slate-300 transition-all duration-200 hover:bg-primary/10 hover:text-primary data-[state=active]:border-primary/20 data-[state=active]:bg-primary/12 data-[state=active]:text-primary data-[state=active]:shadow-none"
          >
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-white/5 transition-colors duration-200 group-hover:bg-primary/10 group-data-[state=active]:bg-primary/10">
