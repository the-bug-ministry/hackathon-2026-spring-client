...
export function MapViewSwitcher({
  ...
  return (
    <div className="absolute top-3 left-1/2 z-30 w-full -translate-x-1/2 px-3 sm:left-6 sm:top-5 sm:w-auto sm:max-w-none sm:translate-x-0 sm:px-0">
      <Tabs
        value={value}
        onValueChange={(next) => onValueChange(next as MapViewMode)}
        className="w-full sm:w-auto"
      >
        <TabsList className="w-full sm:w-auto rounded-2xl px-1 py-1 sm:px-0 sm:py-0 sm:inline-flex">
          <TabsTrigger
            value="2d"
            className="group h-11 w-full sm:w-auto justify-start gap-3 rounded-xl border border-transparent px-3 text-left text-sm font-semibold text-muted-foreground transition-all duration-200 hover:bg-muted hover:text-foreground data-[state=active]:border-border data-[state=active]:bg-muted data-[state=active]:text-foreground sm:h-12 sm:text-base"
          >
          ...
          <TabsTrigger
            value="3d"
            className="group h-11 w-full sm:w-auto justify-start gap-3 rounded-xl border border-transparent px-3 text-left text-sm font-semibold text-muted-foreground transition-all duration-200 hover:bg-primary/10 hover:text-primary data-[state=active]:border-primary/20 data-[state=active]:bg-primary/15 data-[state=active]:text-primary sm:h-12 sm:text-base"
          >
