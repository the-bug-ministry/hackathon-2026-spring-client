...
export const SatellitesMenuList = () => {
  ...
  return (
    <SidebarGroup>
      ...
      <SidebarGroupContent className="max-h-[calc(100dvh-220px)] overflow-auto">
            ...
            return (
              <SidebarMenuItem key={id}>
                <SidebarMenuButton
                  ...
                  className={`group h-auto w-full rounded-2xl border p-0 transition-all duration-200 ${
                    isSelected
                ...
                >
                  <div className="flex w-full items-center gap-3 px-2 py-2">
                    ...
                    <div className="flex shrink-0 items-center gap-2">
                      ...
                      <span
                        className={`rounded-full px-2.5 py-1 text-[10px] font-semibold tracking-wide ${getTypeColor(type)} ${isSelected ? "ring-1 ring-white/10 ring-inset" : ""} `}
                      >
                        {type}
                      </span>
                    </div>
